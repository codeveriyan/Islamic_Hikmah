...
export const APP_THEMES: Record<AppThemeId, { name: string; description: string; preview: [string, string, string]; colors: PalettePair }> = {
  classic: {
    ...
    colors: {
      light: palette("light", { surface: "#FFFFFF", surfaceSecondary: "#F0F2F5", surfaceTertiary: "#E9EDEF", onSurface: "#111B21", onSurfaceMuted: "#667781", onSurfaceSecondary: "#3B4A54", border: "#DFE5E7", brand: "#008069", onBrandPrimary: "#FFFFFF", brandSecondary: "#075E54", error: "#EA0038", success: "#008069", warning: "#F59E0B", gold: "#D4AF37" }),
      dark: palette("dark", { surface: "#0B141A", surfaceSecondary: "#111B21", surfaceTertiary: "#202C33", onSurface: "#E9EDEF", onSurfaceMuted: "#8696A0", onSurfaceSecondary: "#D1D7DB", border: "#222E35", brand: "#00A884", onBrandPrimary: "#062B24", brandSecondary: "#005C4B", error: "#F15C6D", success: "#00A884", warning: "#F59E0B", gold: "#D4AF37" }),
    },
  },
  emerald: {
    name: "Emerald",
    ...
    colors: {
      light: palette("light", { surface: "#F7FFFB", surfaceSecondary: "#EAF8F1", surfaceTertiary: "#D7F0E4", onSurface: "#10251D", onSurfaceMuted: "#5D756B", onSurfaceSecondary: "#304C40", border: "#CBE6D9", brand: "#047857", onBrandPrimary: "#FFFFFF", brandSecondary: "#065F46", error: "#C2414D", success: "#047857", warning: "#F59E0B", gold: "#D4AF37" }),
      dark: palette("dark", { surface: "#061C18", surfaceSecondary: "#0B2923", surfaceTertiary: "#123A31", onSurface: "#ECFDF5", onSurfaceMuted: "#8DB5A5", onSurfaceSecondary: "#C1E4D6", border: "#17483B", brand: "#34D399", onBrandPrimary: "#052E24", brandSecondary: "#0F766E", error: "#FB7185", success: "#34D399", warning: "#F59E0B", gold: "#D4AF37" }),
    },
  },
  midnight: {
    name: "Midnight",
    ...
    colors: {
      light: palette("light", { surface: "#F8FAFF", surfaceSecondary: "#EDF3FC", surfaceTertiary: "#DFE8F7", onSurface: "#132238", onSurfaceMuted: "#617087", onSurfaceSecondary: "#344967", border: "#D2DEEF", brand: "#2563EB", onBrandPrimary: "#FFFFFF", brandSecondary: "#1D4ED8", error: "#DC3652", success: "#0F9F75", warning: "#F59E0B", gold: "#D4AF37" }),
      dark: palette("dark", { surface: "#07111F", surfaceSecondary: "#0D1B2E", surfaceTertiary: "#172943", onSurface: "#EDF5FF", onSurfaceMuted: "#8EA4C1", onSurfaceSecondary: "#C7D8ED", border: "#1D3351", brand: "#60A5FA", onBrandPrimary: "#08172A", brandSecondary: "#1E40AF", error: "#FB7185", success: "#34D399", warning: "#F59E0B", gold: "#D4AF37" }),
    },
  },
  royal: {
    name: "Royal",
    ...
    colors: {
      light: palette("light", { surface: "#FFFBFF", surfaceSecondary: "#F5EEFB", surfaceTertiary: "#EADDF5", onSurface: "#281B33", onSurfaceMuted: "#766582", onSurfaceSecondary: "#4D3B5A", border: "#E2D2ED", brand: "#7C3AED", onBrandPrimary: "#FFFFFF", brandSecondary: "#5B21B6", error: "#CF3F59", success: "#148466", warning: "#F59E0B", gold: "#D4AF37" }),
      dark: palette("dark", { surface: "#160C22", surfaceSecondary: "#211130", surfaceTertiary: "#332047", onSurface: "#FAF5FF", onSurfaceMuted: "#B5A1C3", onSurfaceSecondary: "#E1D2EB", border: "#422A59", brand: "#C084FC", onBrandPrimary: "#251034", brandSecondary: "#7E22CE", error: "#FB7185", success: "#4ADE80", warning: "#F59E0B", gold: "#D4AF37" }),
    },
  },
  desert: {
    name: "Desert",
    ...
    colors: {
      light: palette("light", { surface: "#FFFCF5", surfaceSecondary: "#F8EEDB", surfaceTertiary: "#EFDDBD", onSurface: "#33251A", onSurfaceMuted: "#806D5B", onSurfaceSecondary: "#574435", border: "#E6D2AF", brand: "#B45309", onBrandPrimary: "#FFFFFF", brandSecondary: "#92400E", error: "#C83E4D", success: "#42855B", warning: "#F59E0B", gold: "#D4AF37" }),
      dark: palette("dark", { surface: "#1E140D", surfaceSecondary: "#2A1D13", surfaceTertiary: "#3D2A1B", onSurface: "#FFF7E8", onSurfaceMuted: "#BDA58C", onSurfaceSecondary: "#E7D3BA", border: "#503720", brand: "#FBBF24", onBrandPrimary: "#382309", brandSecondary: "#B45309", error: "#FB7185", success: "#86C995", warning: "#F59E0B", gold: "#D4AF37" }),
    },
  },
  rose: {
    name: "Rose",
    ...
    colors: {
      light: palette("light", { surface: "#FFFAFC", surfaceSecondary: "#FCECF2", surfaceTertiary: "#F5DCE6", onSurface: "#321B25", onSurfaceMuted: "#80616E", onSurfaceSecondary: "#593A47", border: "#EDCFDB", brand: "#BE185D", onBrandPrimary: "#FFFFFF", brandSecondary: "#9D174D", error: "#D42D4D", success: "#27866A", warning: "#F59E0B", gold: "#D4AF37" }),
      dark: palette("dark", { surface: "#210D16", surfaceSecondary: "#2E121F", surfaceTertiary: "#431B2D", onSurface: "#FFF1F5", onSurfaceMuted: "#C39AAA", onSurfaceSecondary: "#E9C9D5", border: "#56243A", brand: "#F472B6", onBrandPrimary: "#35101F", brandSecondary: "#9D174D", error: "#FB7185", success: "#4ADE80", warning: "#F59E0B", gold: "#D4AF37" }),
    },
  },
};
