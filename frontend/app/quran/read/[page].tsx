          ...
          return (
            <View
              ...
              style={[
                styles.surahHeader,
                {
                  backgroundColor: isNightMode ? "#1E293B" : "#F5EFE4",
                  ...
                  <Text
                    ...
                    style={[
                      styles.arabicWord,
                      {
                        ...
                        color: isSelected ? colors.brand : isNightMode ? "#E2E8F0" : "#2C1E10",
                      },
...
export default function QuranReadScreen() {
  ...
  const renderPage = useCallback(({ item }: { item: number }) => (
    <ScrollView
      ...
      style={{ width, height: height - 150, backgroundColor: isNightMode ? "#0A0F1D" : "#FAF7F0" }}
  ...
  return (
    <View style={[styles.container, { backgroundColor: isNightMode ? "#000000" : "#FFFFFF" }]}>
      {/* Top Header */}
      <View style={[styles.header, { borderBottomColor: isNightMode ? "#334155" : "#E2E8F0", backgroundColor: isNightMode ? "#000000" : "#FFFFFF" }]}>
        <Pressable onPress={() => router.back()} hitSlop={10}>
          <MaterialCommunityIcons name="arrow-left" size={24} color={isNightMode ? "#FFF" : "#5C4E3C"} />
        </Pressable>
        <Text style={[styles.title, { color: isNightMode ? "#FFF" : "#5C4E3C" }]}>
      ...
      <View style={[styles.bottomBar, { 
        ...
        <Pressable
          onPress={() => {
            Haptics.impactAsync(Haptics.ImpactFeedbackStyle.Light).catch(() => {});
            alert("To play recitation of the full Surah, choose the Listen tab in the main menu.");
          }}
          style={styles.barBtn}
        >
